      ...
      <div style={{ display: 'flex', gap: '6px', padding: '8px 12px 4px', borderBottom: '1px solid hsl(var(--border))' }}>
        <button
          ...
          style={{
            ...
            background: platform === "instagram" ? "linear-gradient(135deg, #14BBA6, #0D9488)" : 'transparent',
        ...
        <button
          ...
          style={{
            ...
            gap: '6px', padding: '6px', borderRadius: '10px', border: 'none', cursor: 'pointer',
            fontSize: '11px', fontWeight: 600,
            background: platform === "youtube" ? "linear-gradient(135deg, #14BBA6, #0D9488)" : 'transparent',
          ...
          return (
            <button
              ...
              style={{
                ...
                background: active ? (platform === 'youtube' ? 'linear-gradient(135deg, #14BBA6, #0D9488)' : 'linear-gradient(135deg, #14BBA6, #0D9488)') : 'transparent',
