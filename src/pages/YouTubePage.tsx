        ...
        <div className="grid grid-cols-4 gap-1.5">
          {TABS.map((tab) => (
            <button
              ...
              style={activeTab === tab.id ? { background: "linear-gradient(135deg, #FF0000, #CC0000)" } : {}}
            >
        ...
        {activeTab === "seo" && (
          <motion.div initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }} className="space-y-4">
            <div>
              ...
              <p className="text-xs text-muted-foreground">Get optimized title, description and tags for any topic</p>
            </div>
              ...
              <div className="space-y-3">
                ...
                <div className="bg-card border border-border rounded-2xl p-4">
                  <div className="flex items-center justify-between mb-3">
                    ...
                    <button onClick={() => copyText(seoResult.tags?.join(', '), 'tags')} className="flex items-center gap-1 text-xs text-muted-foreground">
              ...
              <div className="flex gap-2">
                {[3, 5, 8, 10].map((d) => (
                  <button
                    ...
                    style={scriptDuration === d ? { background: "linear-gradient(135deg, #FF0000, #CC0000)" } : {}}
                  >
                    {d} min
                  </button>
                ))}
