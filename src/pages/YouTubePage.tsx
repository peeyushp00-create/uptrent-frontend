        ...
        <div className="grid grid-cols-4 gap-1.5">
          {TABS.map((tab) => (
            <button
              ...
              style={activeTab === tab.id ? { background: "linear-gradient(135deg, #FF6B6B, #0D9488)" } : {}}
            >
          ...
          <motion.div initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }} className="space-y-4">
            ...
            <div className="flex gap-2">
              ...
              <button
                ...
                style={{ background: "linear-gradient(135deg, #FF6B6B, #0D9488)" }}
              >
              ...
              <div className="flex gap-2">
                {[3, 5, 8, 10].map((d) => (
                  <button
                    ...
                    style={scriptDuration === d ? { background: "linear-gradient(135deg, #FF6B6B, #0D9488)" } : {}}
                  >
                    {d} min
                  </button>
                ))}
