          ...
          {[1, 2, 3].map((s) => (
            <div key={s} className="flex items-center gap-2">
              <div
                ...
                style={step >= s ? { background: "linear-gradient(135deg, #14BBA6, #0D9488)" } : {}}
              >
                ...
                <div className="flex flex-wrap gap-2 mt-2">
                  {NICHES.map((n) => (
                    <button
                      ...
                      style={niches.includes(n) ? { background: "linear-gradient(135deg, #14BBA6, #0D9488)" } : {}}
                    >
                      {niches.includes(n) && '✓ '}{n}
                    </button>
                  ))}
                ...
                <div className="flex flex-col gap-2">
                  {LANGUAGES.map((l) => (
                    <button
                      ...
                      style={language === l.value ? { background: "linear-gradient(135deg, #14BBA6, #0D9488)" } : {}}
                    >
                      {l.label}
                    </button>
                  ))}
          ...
          {step === 3 && (
            <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} className="space-y-4">
              ...
              <button
                ...
                style={!isRecording ? { background: "linear-gradient(135deg, #14BBA6, #0D9488)" } : {}}
              >
                {isRecording ? (
